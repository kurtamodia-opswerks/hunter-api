...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Raid',
            fields=[
                ('raid_id', models.UUIDField(default=uuid.uuid4, primary_key=True, serialize=False)),
                ('name', models.CharField(max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hunter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='raid_participations', to=settings.AUTH_USER_MODEL)),
                ('raid', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.raid')),
            ],
        ),
        migrations.AddField(
            model_name='hunter',
